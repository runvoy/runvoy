...
func TestLoadOrchestratorEnvironmentVariables(t *testing.T) {
	...
	_ = os.Setenv("RUNVOY_AWS_ORCHESTRATOR_LOG_GROUP", "/aws/lambda/runvoy-orchestrator")
	_ = os.Setenv("RUNVOY_AWS_EVENT_PROCESSOR_LOG_GROUP", "/aws/lambda/runvoy-event-processor")
