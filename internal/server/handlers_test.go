...
func (t *testConnectionRepository) CreateConnection(_ context.Context, _ *api.WebSocketConnection) error {
	return nil
}

func (t *testConnectionRepository) DeleteConnections(_ context.Context, connIDs []string) (int, error) {
	return len(connIDs), nil
}

func (t *testConnectionRepository) GetConnectionsByExecutionID(_ context.Context, _ string) ([]*api.WebSocketConnection, error) {
	return nil, nil
}
...
func (t *testRunner) FetchLogsByExecutionID(_ context.Context, _ string, _ *int64) ([]api.LogEvent, error) {
	return []api.LogEvent{}, nil
}

func TestHandleHealth(t *testing.T) {
	svc := app.NewService(nil, nil, &testConnectionRepository{}, &testRunner{}, testutil.SilentLogger(), constants.AWS, "")
...
func TestHandleRunCommand_Success(t *testing.T) {
	...
	svc := app.NewService(userRepo, execRepo, &testConnectionRepository{}, runner, testutil.SilentLogger(), constants.AWS, "")
	router := NewRouter(svc, 2*time.Second)
...
func TestHandleRunCommand_InvalidJSON(t *testing.T) {
	svc := app.NewService(&testUserRepository{}, nil, &testConnectionRepository{}, &testRunner{}, testutil.SilentLogger(), constants.AWS, "")
	router := NewRouter(svc, 2*time.Second)
...
func TestHandleRunCommand_Unauthorized(t *testing.T) {
	...
	svc := app.NewService(userRepo, nil, &testConnectionRepository{}, &testRunner{}, testutil.SilentLogger(), constants.AWS, "")
	router := NewRouter(svc, 2*time.Second)
...
func TestHandleListExecutions_Success(t *testing.T) {
	...
	svc := app.NewService(&testUserRepository{}, execRepo, &testConnectionRepository{}, &testRunner{}, testutil.SilentLogger(), constants.AWS, "")
	router := NewRouter(svc, 2*time.Second)
...
func TestHandleListImages_Success(t *testing.T) {
	...
	svc := app.NewService(&testUserRepository{}, nil, &testConnectionRepository{}, runner, testutil.SilentLogger(), constants.AWS, "")
	router := NewRouter(svc, 2*time.Second)
